...
It's my own collection of problems that I solve and revisit while working through Physics and Computer Science topics — mainly problems from contests like ICPC & IPhO, and anything else I find interesting in these fields, all solved using C++ and python 
